...
class storess3:
	...
	def delete_files_from_bucket(self, bucket_name, *file_names):
		...
		self.list_all_files_from_bucket(bucket_name)
...
if __name__ == "__main__":
	...
	choices = '''
				  ...
				  '''
	S3_obj.upload_data_to_s3('/Users/bimleshsharma/Desktop/Screenshot-2.png','Screenshot-10.png','bim-auto-bucket')
	S3_obj.list_all_files_from_bucket('bim-auto-bucket')
	S3_obj.delete_files_from_bucket('bim-auto-bucket','Screenshot-5.png','Screenshot-9.png')	
