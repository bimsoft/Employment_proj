...
class storess3:
	...
	def __init__(self):
		...
		self.EAST_SESSION = boto3.Session(region_name = 'us-east-2')

		self.S3 = self.EAST_SESSION.resource('s3') 
...
if __name__ == "__main__":
	...
	choices = '''
				  ...
				  '''
	# S3_obj.create_s3_bucket('bim-auto-bucket-1')
	...
	S3_obj.delete_bucket('bim-auto-bucket-1')
